...
const Card = ({ course }) => {
    return (
        <div className="bg-white rounded-xl border h-full border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
